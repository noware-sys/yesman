...
do
	...
	then
		# Run it.
		echo -e -n "Running '""/etc/yesman/${pkg_name}-${ver_dest}-${arch}-ins-post.sh""'...\n";
		"/etc/yesman/${pkg_name}-${ver_dest}-${arch}-ins-post.sh";
	...
	then
		# Run it.
		echo -e -n "Running '""/etc/yesman/${pkg_name}-any-${arch}-ins-post.sh""'...\n";
		"/etc/yesman/${pkg_name}-any-${arch}-ins-post.sh";
	...
	then
		# Run it.
		echo -e -n "Running '""/etc/yesman/${pkg_name}-${ver_dest}-any-ins-post.sh""'...\n";
		"/etc/yesman/${pkg_name}-${ver_dest}-any-ins-post.sh";
	...
	then
		# Run it.
		echo -e -n "Running '""/etc/yesman/${pkg_name}-any-any-ins-post.sh""'...\n";
		"/etc/yesman/${pkg_name}-any-any-ins-post.sh";
	...
	then
		# Run it.
		echo -e -n "Running '""/etc/yesman/any-any-any-ins-post.sh""'...\n";
		"/etc/yesman/any-any-any-ins-post.sh";
